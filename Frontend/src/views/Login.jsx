    ...
    return(
        <div className="min-h-screen min-w-full bg-gradient-to-tl from-sky-950 to-black relative flex items-center justify-center">
            ...
            <div className="grid gap-y-10 bg-slate-800 text-white pt-10 pb-10 pl-10 pr-10 rounded-md">
                ...
                <button className="bg-gradient-to-r from-red-500 to-orange-400 active:from-red-600 active:to-orange-500 hover:cursor-grab rounded-4xl py-2 w-1/5 hover:shadow-[1px_1px_5px_rgba(0,0,0,0.2)] hover:shadow-red-400 transition-all duration-200">Log In</button>
            </div>
        </div>
    )
}
